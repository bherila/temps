...
impl PullExternalImageJob {
    ...
    /// Extract the registry host from an image reference, if one was specified.
    ...
    /// Normalize a configured registry URL to the host[:port] Docker will use for matching.
...
mod tests {
    ...
    #[test]
    fn test_registry_from_image_ref_normalizes_registry_host() {
        assert_eq!(
    ...
    #[test]
    fn test_registry_host_from_url_normalizes_configured_registry() {
        assert_eq!(
